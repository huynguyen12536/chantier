...
import { mapPasswordResetError, resetPasswordWithOtp, sendPasswordResetOtp } from '@/utils/passwordResetOtp';
            ...
            <View style={styles.mainBlock}>
              ...
              <View style={styles.form}>
                {success ? (
                  ...
                  <>
                    <Text style={styles.title}>{t.resetPassword.title}</Text>
                    <Text style={styles.subtitle}>{t.resetPassword.subtitleOtp}</Text>
